...
// $Id: XmlParser.java,v 2.6 1998/05/02 00:56:52 david Exp $
...
public class XmlParser {
     ...
     * @throws java.lang.Exception Any exception thrown by your
    ...
    void parseElement()
        ...
        gi = readNmtoken(true);
        if (handler != null) handler.startElement(gi);
     ...
     */
    void parseDefault(String elementName, String name, int type, String enumStr)
            throws java.lang.Exception {
