...
public class ReadGXLUnitTest {
    ...
    void read() throws MalformedURLException {
        ...
        GXLConverterAPI.createGXL(new de.tudresden.inf.st.bigraphs.converter.gcf.DefaultImpl1.GXLGXLAPIImpl());
        ...
        de.tudresden.inf.st.bigraphs.converter.gcf.DefaultImpl1.GXLOutputAPI.createOutputFile(TARGET_DUMP_PATH + "Demo.xml");
...
//        Path path = Paths.get("/home/dominik/git/BigraphFramework/visualization/gxldemo.xml");
        ...
        de.tudresden.inf.st.bigraphs.converter.gcf.DefaultImpl1.GXLOutputAPI.closeOutputFile();
    }
}
