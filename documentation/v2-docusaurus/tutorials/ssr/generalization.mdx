...
|------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
| ![SSR3](../assets/ssr/lts-ssr3.png) <br/> Nodes: 78 <br/> Edges: 96 <br/> Time: 0.70 s | ![SSR4](../assets/ssr/lts-ssr4.png) <br/> Nodes: 1,263 <br/> Edges: 2,767 <br/> Time: 10.02 s | ![SSR5](../assets/ssr/lts-ssr5.png) <br/> Nodes: ≈ 9,192 <br/> Edges: 22,047 <br/> Time: 105.56 s |
...
It also demonstrates the power of a **single, parameterized bigraph specification**,
which can model systems of varying sizes without requiring substantial changes to the rules.
