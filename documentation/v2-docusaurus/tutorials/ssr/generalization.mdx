...
The following transition systems were automatically generated using [*BiGGer* and *GrGen.NET*](https://github.com/bigraph-toolkit-suite/bigraphs.grgen-bigraphs), modeling the state space of multiple robots performing a physical bubble-sort along the grid.
