...
title: Outline
sidebar_position: 1
description: Stream ROS2 data into bigraphs, persist models with CDO, and apply conditional rewriting rules.
---

![overview-architecture.png](../assets/ros2cdo/overview-architecture.png)
...
When the value is "low enough," a rule turns the agent’s energy marker from `HIGH` to `LOW`.
