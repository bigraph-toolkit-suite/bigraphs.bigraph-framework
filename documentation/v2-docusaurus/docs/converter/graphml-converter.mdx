...
The _GraphML_ file format allows representing arbitrary graphs in an XML-based structure.
...
The GraphML Schema defines the syntax of _GraphML_.
The XML schema of _GraphML_ is provided with **Bigraph Framework**
and supports syntax validation of the encoded bigraph.
