...
:::note
The dedicated link graph matching discussed on this page should not be confused with the conventional notion of bigraph matching (i.e., a form of subgraph matching).
See also the algorithmic notes in [Performing the Subhypergraph Matching](#performing-the-subhypergraph-matching).
:::
