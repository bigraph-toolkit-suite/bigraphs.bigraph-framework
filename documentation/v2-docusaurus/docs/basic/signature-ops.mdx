...
Signature composition can be performed via the method [org.bigraphs.framework.core.utils.BigraphUtil#composeSignatures](https://bigraphs.org/products/bigraph-framework/apidocs/org/bigraphs/framework/core/utils/BigraphUtil.html#composeSignatures(org.bigraphs.framework.core.impl.signature.DynamicSignature,org.bigraphs.framework.core.impl.signature.DynamicSignature)).
