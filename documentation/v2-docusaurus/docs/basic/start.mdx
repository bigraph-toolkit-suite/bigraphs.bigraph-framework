...
For a complete reference, see the [JavaDoc of the `BigraphComposite` interface](https://bigraphs.org/software/bigraph-framework/apidocs/org/bigraphs/framework/core/BigraphComposite.html).
:::
