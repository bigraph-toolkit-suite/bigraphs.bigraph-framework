...
> and the corresponding implementation [Spring Data CDO](https://github.com/bigraph-toolkit-suite/spring-data-cdo) for working with the [Spring framework](https://spring.io/).
