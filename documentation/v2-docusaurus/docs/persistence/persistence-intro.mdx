...
Refer to [Bigraph Ecore Metamodel](https://github.com/bigraph-toolkit-suite/bigraphs.bigraph-ecore-metamodel?tab=readme-ov-file#how-to-use-the-specification), to learn more technical details about the metamodel of the bigraphs framework.
