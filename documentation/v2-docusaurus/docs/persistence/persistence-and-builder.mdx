...
[This example](https://github.com/bigraph-toolkit-suite/bigraphs.bigraph-framework/blob/main/core/src/test/java/org/bigraphs/framework/core/StorageUnitTest.java) shows how to store a bigraph and its signature to the filesystem, and how to load them again.
