...
<center>
    <p>
        ...
        <i>Last Updated: 2025-09-05</i>
    </p>
</center>


- **Stable**: <span class="badge badge-secondary" style={{backgroundColor: '#19c37d'}}>2.1.2</span>
- Previous Stable Versions: 2.1.1, 2.1.0
...
<table border="0">
        ...
        <tr>
            <td>2.0.1, 2.0.2, 2.1.0, 2.1.1, 2.1.2</td>
            <td>2.0.1, 1.6.1</td>
        </tr>
</table>
