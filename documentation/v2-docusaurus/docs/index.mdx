...
- Relatively Stable: 0.9.6 (master branch)
- Latest Version: 0.9.7-SNAPSHOT (develop branch)
...
Otherwise, to build the source by yourself, follow the [README.md](https://git-st.inf.tu-dresden.de/bigraphs/bigraph-framework/blob/master/README.md) inside the repository.
:::
