...
- Latest Version: <span class="badge badge-secondary" style={{backgroundColor: '#7952b3'}}>2.0.0-SNAPSHOT</span> (develop branch)
...
- Attributed Bigraphs
    ...
    - Attributes are preserved when rewriting (this requires tracking maps)
