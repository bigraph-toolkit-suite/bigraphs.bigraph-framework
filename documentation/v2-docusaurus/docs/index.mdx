...
<center>
    <p>
        ...
        <i>Last Updated: 2025-08-18</i>
    </p>
</center>


- **Stable**: <span class="badge badge-secondary" style={{backgroundColor: '#19c37d'}}>2.1.1</span>
- Previous Stable Versions: 2.1.0, 2.0.2
